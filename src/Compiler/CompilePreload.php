...
final class CompilePreload
{
    ...
    public function __construct(private FakeRun $fakeRun, private NewInstance $newInstance, private CompileAutoload $dumpAutoload, private FilePutContents $filePutContents, private ArrayObject $classes, private string $context)
    {
